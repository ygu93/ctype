	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function generateAsteroid() {
	      ...
	      this.asteroids.push(new _asteroid2.default({ pos: this.randomPosition(), name: waveWord }, this));
	    }
	  }, {
	    key: 'randomPosition',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Asteroid = function (_MovingObject) {
	  ...
	  function Asteroid(options, game) {
	    ...
	    options.radius = 10;
	    options.vel = _util2.default.randomVec(options.pos, 1000);
